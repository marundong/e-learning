package com.el.user.service.user;
...
import com.el.user.mapper.user.MenuMapper;
import com.el.user.mapper.user.UserMapper;
import com.el.user.repository.user.UserRepository;
...
public class UserService {
    ...
    public UserPermissionResult getUserPermission(String userId){
        UserPermissionResult userPermissionResult = new UserPermissionResult();
        List<ElMenu> menuList = menuMapper.selectMenuByUserId(userId);
        userPermissionResult.setPermissions(menuList);
